...
//        } else if
    ...
    private static List<XMBItem> generateSettings() {
        ...
        innerSettings.add(new HomeItem(Type.nonDescriptSetting, "Media Player", DataRef.from(ResImage.get(R.drawable.ic_baseline_settings_24).getId(), DataLocation.resource), innerInnerSettings.toArray(new XMBItem[0])));
        innerInnerSettings.clear();
